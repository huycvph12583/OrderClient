...
public class LoaiThucDonSpinnerAdapter2 extends ArrayAdapter<LoaiThucDon> {
    private Context context;
    private ArrayList<LoaiThucDon> lists;
    TextView tv_tenloaitd;

    public LoaiThucDonSpinnerAdapter2(@NonNull Context context, ArrayList<LoaiThucDon> lists) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.loai_thuc_don_item_spinner2, null);
        }
